...
def fetch_store():
    ...
    for city in range(1, 5):
        for page in range(1, 100):
            url = "https://www.rentfaster.ca/api/search.json?keywords=&proximity_type=location-proximity&beds=&type%5B%5D=Apartment&type%5B%5D=Condo&type%5B%5D=Loft&price_range_adv%5Bfrom%5D=null&price_range_adv%5Bto%5D=null&novacancy=0&city_id={}&cur_page={}".format(
                city, page
            )
            ...
            for listing in listings:
                ...
                ext = tldextract.extract(str(listing["website"]))
